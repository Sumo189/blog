...
export const navBarConfig: NavBarConfig = {
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [LinkPreset.Anime, LinkPreset.Diary],
		},
		{
			name: "关于",
			url: "/content/",
...
export const profileConfig: ProfileConfig = {
	avatar: "https://gcore.jsdelivr.net/gh/Sumo189/cdn@main/tx.jpg", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Sumo",
	bio: "以傲慢与偏执，回敬傲慢与偏见",
	links: [
		{
			...
			url: "https://github.com/Sumo189",
		},
		{
			name: "Email",
			icon: "mdi:email",
			url: "mailto:seasnow233@163.com",
		},
	],
};
...
export const commentConfig: CommentConfig = {
	...
	twikoo: {
		envId: "https://ltp-twikoo.jkun.cf/",
